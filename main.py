...
APP_TYPE = "100"
APP_ID_HASH = os.getenv("APP_ID_HASH")  # SHA-256 hash of appId-appType:appSecret
...
async def get_access_token():
    ...
    if send_otp_result[0] != SUCCESS:
        ...
        print(f"send_login_otp success - {send_otp_result[1]}")
    ...
    if generate_totp_result[0] != SUCCESS:
        ...
        print(f"generate_totp success - {generate_totp_result[1]}")
    ...
    if verify_totp_result[0] != SUCCESS:
        ...
        print(f"verify_totp_result success - {verify_totp_result[1]}")
    ...
    if verify_pin_result[0] != SUCCESS:
        ...
        print(f"verify_pin_result success - {verify_pin_result[1]}")
    ...
    if token_result[0] != SUCCESS:
        ...
        print(f"token_result success - {token_result[1]}")
    ...
    if token_result[0] != SUCCESS:
        ...
        print(f"validate_authcode success - {validate_authcode_result[1]}")
